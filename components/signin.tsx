...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="hidden md:flex flex-1 bg-blue-600 justify-center items-center p-4">
        <div className="relative w-full h-full bg-[#346BD4] rounded-lg flex justify-center items-center">
          {/* Inner Rectangle */}
          <div className="relative w-[80%] h-[80%] bg-[#B7E9F6] rounded-lg flex flex-col justify-center items-start">
            {/* Logo and Text */}
      ...
      {/* Header and Login Form (Visible on mobile) */}
